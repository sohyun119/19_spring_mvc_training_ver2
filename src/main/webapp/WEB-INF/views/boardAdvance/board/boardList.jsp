...
<body>
	...
	<p align="right">
		<input type="button" value="테스트 데이터 생성" onclick="location.href='/boardAdvance/addBoardDummy'">
	</p>
	...
	<div align="center" style="padding-top: 100px" >
		...
		<table border="1">
			...
			<tbody id="boardList">
				<c:forEach var="mainBoardDTO" items="${boardList }">
					<tr align="center">
						...
						<td>${startBoardIdx }</td>
						<td align="left">
							<a href="/boardAdvance/boardDetail?boardId=${mainBoardDTO.boardId }">${mainBoardDTO.subject }</a>
						</td>
			...
			<tr align="right">
				<td colspan="5">
					<input type="button" value="글쓰기" onclick="location.href='/boardAdvance/addBoard'">
				</td>
			</tr>
			<tr>
