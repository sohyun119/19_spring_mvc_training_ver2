...
<body>
	<div align="center">
		<form action="/member/register" onsubmit="return checkFormValidation();" method="post" enctype="multipart/form-data">
			<h3>회원가입</h3>
			<table border="1">
				<tr>
					<td>아이디</td>
		        ...
		        <tr>
			        <td>생년월일</td>
			        <td>
						<input type="text" name="birthAt" placeholder="yyyy-MM-dd">
			        </td>
		        </tr>                        
		        <tr>
			        <td>핸드폰 번호</td>
			    ...
			    <tr>
			        <td colspan="2" align="center">
			        	이미 회원가입이 되어있다면 ? <a href="/member/login"><strong>로그인하기</strong></a>
			        </td>
		        </tr>                            
		     </table>
	     </form>
